...
const PROVIDERS: Array<{
...
}> = [
  {
    ...
    writable: true,
    oauth: true, // Uses "Connect with Google" button
    ...
    <div className="space-y-8">
      ...
      {!activeProvider && (
        <div>
          ...
          <div className="mb-4">
            ...
            >
              ...
              <div className="flex-grow">
                ...
                <p className="text-xs text-gray-500">
                  One click — sign in with your Google account to connect your calendar
                </p>
              </div>
              <svg
          ...
          {/* Other providers (manual setup) */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {PROVIDERS.filter((p) => !p.oauth).map((p) => (
              <button
                key={p.id}
