...
const WELCOME_MESSAGE: Message = {
  id: "welcome",
  text: "Good morning! I'm your Financial Intelligence Agent. I track revenue, expenses, margins, and anomalies for Saffron Kitchen. What would you like to review?",
  sender: "bot",
  timestamp: new Date(),
};

export default function SaffronFinanceDemo() {
    ...
    <div className="flex flex-col h-[100dvh] bg-[#09090b] text-white">
      ...
      <header className="flex items-center gap-3 px-4 py-3 bg-[#111113] border-b border-[#222] shrink-0">
        <div className="relative">
          <div className="w-10 h-10 rounded-full bg-gradient-to-br from-amber-500 to-amber-700 flex items-center justify-center text-lg font-bold">
            $
          </div>
        ...
        <div className="flex-1 min-w-0">
          <h1 className="text-base font-semibold truncate">
            Financial Intelligence — Saffron Kitchen
          </h1>
        ...
        <div className="text-[10px] text-amber-500 uppercase tracking-wider font-medium px-2 py-1 rounded bg-[#1a1a1a] border border-amber-500/30">
          Finance
        </div>
      </header>
      ...
      >
        <input
          ...
          placeholder="Ask about revenue, costs, margins..."
          disabled={isTyping}
