...
const agents = [
  {
    ...
    description:
      "Every business gets a custom AI persona — a character with a full backstory, personality, and voice. She never breaks character. Never says she's an AI. She texts like a real person: 2-3 short messages with natural timing, not a wall of text. The AI auto-improves with every conversation. Customers send voice notes — she transcribes, understands, and replies with her own voice in Arabic or English. She works across WhatsApp, your website widget, Telegram, and Instagram DM — same personality, same memory, every channel. Arabic messages automatically route to a native Gulf Arabic model for natural conversations, not broken translation. Every customer gets persistent memory across conversations: name, allergies, dietary restrictions (and WHO has them), favorite dishes, usual party size, preferred seating, visit timing, booking history, and sentiment tracking. A guest who messaged in January is greeted by name in December.",
    benefits: [
      "Custom AI persona with unique backstory, personality, and voice",
      "Multi-message replies — texts like a real person, not a bot",
      "Voice notes: listens, transcribes, and responds with her own voice",
      "Multi-channel: WhatsApp + website widget + Telegram + Instagram DM",
      "Smart language routing: native Gulf Arabic + English auto-detection",
      ...
      <nav className="fixed top-0 left-0 right-0 z-40 px-4 pt-4">
        <div className="max-w-6xl mx-auto flex items-center justify-between bg-surface-950/70 backdrop-blur-2xl rounded-full px-6 py-3 ring-1 ring-white/[0.06]">
          ...
          <div className="hidden md:flex items-center gap-7 text-[13px] font-medium text-white/40">
            ...
            <a href="/app/signup/" className="rounded-full bg-white/[0.06] hover:bg-white/[0.1] px-5 py-2 text-[13px] font-semibold text-white/60 transition-all duration-300 active:scale-[0.97]">
              Sign up
            </a>
